            ...
            render: (record) => {
                if (record.status === 'PLACED')
                    return (
                        <Space>
                            {record.status}
                            <Button type={"primary"} onClick={() => handleAccept({pid: record._id})} style={{ background: "green", borderColor: "black"}}>ACCEPT</Button>
                            <Button type={"primary"} style={{ background: "red", borderColor: "black"}} onClick={() => handleReject({pid: record._id})}>REJECT</Button>
                        </Space>
                    )
